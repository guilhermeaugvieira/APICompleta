...
namespace DevIO.API.Extensions
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            // Recebe a parte do form que contém o JSON
            ...
            // Bind cada propriedade do IFormFile de outras partes
            foreach (var property in bindingContext.ModelMetadata.Properties)
            {
                ...
                {
                    // O IFormFile foi vinculado com sucesso, atribuido a propriedade correspondente do modelo
            ...
            // Seta o modelo construído com sucesso como resultado do binding do modelo
